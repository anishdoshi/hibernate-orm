 ...
 */
public class JoinedSubclassBulkManipTest extends FunctionalTestCase
{

	public JoinedSubclassBulkManipTest(String name) {
		super( name );
	}

    public String[] getMappings()
    {
        return new String[] { "hql/joinedSubclass/Person.hbm.xml" };
    }
